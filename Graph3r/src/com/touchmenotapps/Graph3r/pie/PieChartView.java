...
public class PieChartView extends View {
	...
	private ArrayList<PieChartObject> mDataArray;
	...
	public PieChartView(Context context, PieGraphRenderer renderer) {
		super(context);
		mRenderer = renderer;
	...
	protected void onDraw(Canvas canvas) {
		...
		mStart = START_INC;
		PieChartObject plotDetail;
		for (int i = 0; i < mDataArray.size(); i++) {
			plotDetail = (PieChartObject) mDataArray.get(i);
